...
int cmphallgato(const void *bal, const void *jobb)
{
    const Hallgato *a = (const Hallgato*) bal;
    const Hallgato *b = (const Hallgato*) jobb;
...
int main()
{
    ...
    qsort(hallgatok, hallgatok_szama, sizeof(Hallgato), cmphallgato);
